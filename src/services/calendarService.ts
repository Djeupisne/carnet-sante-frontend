...
export const calendarService = {
  ...
  createCalendar: async (calendar: { date: string; slots: string[] }): Promise<{ success: boolean; data: Calendar }> => {
    try {
  ...
  updateCalendar: async (calendarId: string, calendar: Calendar): Promise<{ success: boolean; data: Calendar }> => {
    try {
